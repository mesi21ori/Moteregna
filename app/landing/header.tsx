...
//         }
//       } catch (error) {
//         // Don't redirect here to allow public header access
//       } finally {
//         setMounted(true)
//       }
//     }
...
//             <Link href="/signin">
//               <Button variant="outline" className="border-motergna-red text-motergna-red hover:bg-motergna-red/10 w-full">
//                 Sign In
//               </Button>
//             </Link>
//             <Link href="/signup">
